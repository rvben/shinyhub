...
ALTER TABLE replicas ADD COLUMN data_producer_deployment_id BIGINT;
...
ALTER TABLE apps ADD COLUMN data_write_sequence BIGINT NOT NULL DEFAULT 0;
...
CREATE TABLE schedule_data_uncertainty (
    ...
    data_write_sequence BIGINT NOT NULL,
    schedule_run_id BIGINT NOT NULL,
