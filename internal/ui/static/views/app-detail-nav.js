...
export const TAB_ROUTES = ['overview', 'usage', 'logs', 'traces', 'deployments', 'schedules', 'configuration', 'data', 'access'];
export const MANAGER_ONLY_TABS = new Set(['usage', 'configuration', 'data', 'access']);
