...
func TestValidateWorkerSettings(t *testing.T) {
	tests := []struct {
		...
		{"negative warm spares rejected", WorkerSettings{Isolation: IsolationPerSession, MaxWorkers: 2, WarmSpares: -1}, false, 0, 0, "warm_spares"},
		{"negative multiplex warm spares rejected", WorkerSettings{Isolation: IsolationMultiplex, WarmSpares: -1}, false, 0, 0, "warm_spares"},
		{"multiplex warm spares above storage range rejected", WorkerSettings{Isolation: IsolationMultiplex, WarmSpares: 1001}, false, 0, 0, "warm_spares"},
		{"warm spares above max rejected", WorkerSettings{Isolation: IsolationPerSession, MaxWorkers: 2, WarmSpares: 3}, false, 0, 0, "warm_spares"},
		{"warm spares accepted", WorkerSettings{Isolation: IsolationPerSession, MaxWorkers: 2, WarmSpares: 1}, false, 0, 0, ""},
