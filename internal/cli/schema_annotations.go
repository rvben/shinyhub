...
var schemaAnnotations = map[string]cmdAnnotation{
	...
	"fleet apply": {Mutating: mut, OutputFields: []fieldSpec{
		{Name: "failure_kind", Type: "string", Desc: "deploy failure classification on a failed app: runtime_missing, build_failed, hook_failed, bundle_invalid, readiness_timeout, crashed, server_error, zip_error, transport_error, or unknown"},
