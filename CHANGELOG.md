...
- **Documentation navigation**: add direct homepage links to the documentation, live demo, and installation guide.
...
- **db**: add fenced elastic session reservations that serialize capacity admission and idempotent client reservations under the current controller lease, retaining capacity across takeover and deployment changes until cleanup is confirmed. The storage primitive stays internal until remote launch acknowledgement and worker fencing are integrated.
...
- **recovery**: keep dead apps wakeable after restart ([f3e3abd](https://github.com/rvben/shinyhub/commit/f3e3abdad69b73d6661031d37b605081e049b685))
